...
WORK=$ROOT/build/module-data-differential
SOURCE=$ROOT/test/fixtures/module_data.f90
...
"$FC" -std=f2018 -pedantic -O2 -Wall -Wextra -J"$WORK" "$SOURCE" -o "$WORK/native"
