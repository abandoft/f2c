...
WORK=$ROOT/build/reduction-intrinsic-differential
SOURCE=$ROOT/test/fixtures/reduction_intrinsics.f90
...
echo "reduction intrinsic differential and sanitizer validation passed"
