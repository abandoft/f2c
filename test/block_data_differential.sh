...
WORK=$ROOT/build/block-data-differential
SOURCE=$ROOT/test/fixtures/block_data_common.f90
...
"$FC" -std=f2018 -pedantic -O2 -Wall -Wextra "$SOURCE" -o "$WORK/native"
