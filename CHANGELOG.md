...
- Lengthened short DGER and DTRSM measurement windows to reduce shared-runner noise without relaxing the per-case 5% performance threshold.
...
- Tweak mkfile.plan9 to generate sysdep.hd and add mkfile.plan9 to
  src.tgz and the makefile variants.  Thanks to Fernan Bolando
  <fernanbolando@gmail.com> for helpful E-mail.
  makefile.vc needs tokdefs.h from makefile.u or mkfile.plan9.
...
- Adjusted updates to 20240312:  missed updating some files; version.c
  still says 20240312.
...
- Fix a glitch (missed case) with the new "-cf" command-line option.
