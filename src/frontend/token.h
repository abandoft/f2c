...
/* A compact run mapping normalized logical text back to one contiguous range
 * in the original physical source.  Logical and physical columns are
 * zero/one based respectively, and the physical range advances one column per
 * character. */
